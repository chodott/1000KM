//Shader "Hidden/Amazing Assets/Curved World/TerrainEngine/Classic Runner (X Negative) ID 2/Details/UniversalPipeline/Vertexlit/"
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#include "../TerrainDetailLitPasses.hlsl"
            ENDHLSL
        }
